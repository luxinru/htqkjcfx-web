                ...
                color: [
                  [
                    ...
                    new echarts.graphic.LinearGradient(0, 0, 1, 0, [
                      {
                        offset: 0,
                        color: this.dataList[0].gradientColors.start
                      },
                      {
                        offset: 1,
                        color: this.dataList[0].gradientColors.end
                      }
                    ])
                  ],
                  [1, this.dataList[0].gradientColors.start]
                ]
              }
            },
            pointer: {
                ...
                color: [
                  [
                    ...
                    new echarts.graphic.LinearGradient(0, 0, 1, 0, [
                      {
                        offset: 0,
                        color: this.dataList[1].gradientColors.start
                      },
                      {
                        offset: 1,
                        color: this.dataList[1].gradientColors.end
                      }
                    ])
                  ],
                  [1, this.dataList[1].gradientColors.start]
                ]
              }
            },
            pointer: {
